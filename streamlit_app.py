...
def draw_water_tank_and_hospital(fill_level):
    ...
    ax.text(22.5, -22, "2400W",fontsize=8,  color='purple', ha='center')
    ...
    ax.text(40, -12, "2400W",fontsize=8,  color='purple', ha='center')
...
def main():
    ...
    tank_fill_level = st.slider("Nível da caixa dágua", 0.0, 1.0, 0.5, step=0.05)
